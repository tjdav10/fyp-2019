...
void setup()
{
  ...
  /* Set the device name */
  Bluefruit.setName("Proximity Test Central");
  ...
  Bluefruit.Scanner.setInterval(160, 80);       // in units of 0.625 ms (160*0.625ms = 100ms)
...
/* Prints a UUID16 list to the Serial Monitor */ //not necessary
...
/* Prints a UUID128 list to the Serial Monitor */ //not necessary
